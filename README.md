...
You need a VPS with **Docker**, **Docker Compose** and **Git**, plus a **GitHub OAuth App** (takes 2 minutes; the [install guide](docs/install.md#step-1-create-a-github-oauth-app) walks you through it). No Claude Code install on the host.
...
The wizard asks for your domain, the GitHub OAuth credentials and the allowed GitHub usernames, derives everything else, and offers to start the stack. If you skipped that last step:
...
- **[Install guide](docs/install.md)**: every step spelled out, from the GitHub OAuth App to your first Session.
